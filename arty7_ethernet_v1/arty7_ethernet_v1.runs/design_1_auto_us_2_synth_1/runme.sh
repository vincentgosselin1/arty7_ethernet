...
HD_PWD='C:/Xilinx/Vivado/2021.1/myDev/arty7_ethernet_v1/arty7_ethernet_v1/arty7_ethernet_v1.runs/design_1_auto_us_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_auto_us_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_auto_us_2.tcl
